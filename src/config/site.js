...
const SITE_URL = import.meta.env.PUBLIC_SITE_URL || 'https://yagomolano.github.io/';

export const siteConfig = {
	title: "Yago Molano Portfolio",
	author: "Yago Molano",
	url: SITE_URL,
	mail: "yagomolano@gmail.com",
	// resume add your resume file path here: /assets/resume.pdf
	resume: "/assets/Resume_Yago_Molano.pdf",
	utm: {
		source: `${SITE_URL}`,
		medium: "referral",
		campaign: "navigation",
...
export const socialLinks = [
	{
		name: 'Github',
		url: 'https://github.com/yagomolano',
